...
def web_qrcode_start(obj):
    if not wlan_sta.isconnected():
        ...
        lcd.fill(lcd.BLACK)
        with open("apikey.pem") as f:
            apikey = f.read()
        api_url = 'http://api.m5stack.com/v1/{}/listdir/flash'
        lcd.qrcode(api_url.format(apikey), 126, 46, 175)
        lcd.setColor(0xaaaaaa, lcd.BLACK)
        lcd.print("KEY:"+apikey, 0, 0, color=0xaaaaaa)
